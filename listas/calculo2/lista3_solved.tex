...
\begin{enumerate}
    ...
    \begin{enumerate}[label=1.\arabic*.]
        ...
        \begin{enumerate}[label=(\alph*)]
            ...
            \begin{figure}[!ht]
                \centering 
                \includegraphics[width=0.7\linewidth]{imgs/nivel5.png} 
                \label{fig:imagem1}
            \end{figure}
            \item $f(x, y, z) = sen(x^2 + y^2 + z^2), \hspace{1cm} c = -1, -\frac{1}{2}, 0, \frac{\sqrt{2}}{2}, 1$
            \begin{figure}[!ht]
                \centering 
                \includegraphics[width=0.7\linewidth]{imgs/nivel6.png} 
                \label{fig:imagem1}
            \end{figure}
        \end{enumerate}
    \end{enumerate}
    ...
    \begin{figure}[!ht]
        ...
        \begin{subfigure}{\textwidth} 
            \centering
            \includegraphics[width=0.3\linewidth]{imgs/anim1.png} 
            \label{fig:imagem1}
        \end{subfigure}
        \begin{subfigure}{\textwidth} 
            \centering
            \includegraphics[width=0.3\linewidth]{imgs/anim2.png} 
            \label{fig:imagem2}
        \end{subfigure}
    ...
    \begin{figure}[!ht]
        ...
        \begin{subfigure}{\textwidth} 
            \centering
            \includegraphics[width=0.3\linewidth]{imgs/anim3.png} 
            \label{fig:imagem1}
        \end{subfigure}
        \begin{subfigure}{\textwidth} 
            \centering
            \includegraphics[width=0.3\linewidth]{imgs/anim4.png} 
            \label{fig:imagem2}
        \end{subfigure}
        \label{fig:exemplo_duas_imagens} 
    \end{figure} \\
    ...
    \begin{figure}[!ht]
        ...
        \begin{subfigure}{\textwidth} 
            \centering
            \includegraphics[width=0.3\linewidth]{imgs/tensorfield1.png} 
            \label{fig:imagem1}
        \end{subfigure}
        \begin{subfigure}{\textwidth} 
            \centering
            \includegraphics[width=0.3\linewidth]{imgs/tensorfield2.png} 
            \label{fig:imagem2}
        \end{subfigure}
        \label{fig:exemplo_duas_imagens} 
    \end{figure} \\
